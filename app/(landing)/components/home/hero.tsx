    ...
    <section id="hero-section" className="container mx-auto h-screen flex">
      <div className="relative self-center">
        ...
        <div className="relative ml-40 w-full">
          ...
          <h1 className="font-extrabold text-[95px] leading-tight italic bg-gradient-to-b leading-tight from-black to-[#979797] bg-clip-text text-transparent">
          ...
          <div className="flex gap-5 mt-14">
            <Button>
                Explore More <FiFastForward/> </Button>
