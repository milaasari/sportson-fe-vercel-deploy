    ...
    <header>
      <div className="flex justify-between gap-10 container mx-auto py-7">
        ...
        <nav className="flex gap-44 font-medium">
          <Link href="#"className="relative after:content-[''] after:block after:bg-primary after:rounded-full after:h-[3px] after:w-1/2 after:absolute after:left-1/2 after:-translate-x-1/2 after:trabslate-y-1">Home</Link>
